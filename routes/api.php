...
|--------------------------------------------------------------------------
|
| These routes are for API communication. They are stateless and intended
| to be consumed by frontend applications like AngularJS.
|
*/
...
// Route::get('/carts', [OrderController::class, 'getAllCarts']);
